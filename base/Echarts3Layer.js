			...
			return e(
					...
					null,
					{
						...
						constructor : function(e, t) {
							this._map = e;
							var n = this._echartsContainer = document
									.createElement("div");
							n.style.position = "absolute",
									n.style.height = e.height + "px",
									n.style.width = e.width + "px",
									n.style.top = 0, n.style.left = 0,
									e.__container.appendChild(n), this._init(e,
											t)
						},
						_init : function(e, t) {
							console
									.log('<a href="https://github.com/wandergis/arcgis-echarts3">develop by wandergis</a>');
							var o = this;
									o._map = e,
									o._ec = t,
									...
									o.initECharts = function() {
										return
												o._ec = t.init.apply(o,
														arguments),
												o._ec.Geo.prototype.dataToPoint = function(
														e) {
													var t = new n(e[0], e[1]), i = o._map
															.toScreen(t);
													return [ i.x, i.y ]
									...
									o._bindEvent = function() {
														...
														.on(
																...
																function() {
																	var e = o._echartsContainer.parentNode.parentNode.parentNode;
																			...
																			o._echartsContainer.style.left = o._mapOffset[0]
																					+ "px",
																			o._echartsContainer.style.top = o._mapOffset[1]
																					+ "px",
																			setTimeout(
																					function() {
																								o._map
												...
												o._ec
														...
														.on(
																"mousewheel",
																function(e) {
																	o._lastMousePos = o._map
																			.toMap(new i(
																					e.event.x,
																					e.event.y));
																	var t = e.wheelDelta, n = o._map, a = n
																			.getZoom();
																			t = t > 0 ? Math
																					.ceil(t)
																					: Math
